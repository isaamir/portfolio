...
const skillsSection = {
  title: "What I do",
  subTitle: "FULL STACK DEVELOPER WHO WANTS TO EXPLORE WEB DEVELOPMENT AND WEB3 TECHNOLOGIES",
  skills: [
    emoji(
    ...
    emoji(
      "⚡ GraphQL and RESTful APIs development and integrations"
    )
  ],
...
const techStack = {
  ...
  experience: [
    ...
    {
      Stack: "Backend Micro Services Development",
